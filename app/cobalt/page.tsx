...
export default function Cobalt() {
  return (
    <div className="flex flex-col w-full gap-8 p-16 max-w-2xl overflow-y-auto h-full">
      <span className="text-sm text-cobalt-300">
        Cobalt is the name of the custom color palette this site uses. Technically cobalt is more blue, not purple, but
        I wanted a metal-like name similar to {"Tailwind's"} Slate, Zinc, or Stone, and Cobalt sounds cool.
      </span>
